...
INSERT INTO Kitaplar(KitapAdi,Isbn,YayineviAdi,YazarTC)
VALUES('Teneke',1899,'Ýþ Bankasý', '12385670902')

INSERT INTO Kitaplar(KitapAdi,Isbn,YayineviAdi,YazarTC)
VALUES('Vatan Yahut Silistre' ,1903, 'Palme','12090651913')
--YAYINEVÝ EKLEME
...
INSERT INTO Yayinevi(YayýneviAdi,YayýneviAdres,YayýneviTel)
VALUES('Palme','Isparta',01189290223)
--YAZAR EKLEME
...
INSERT INTO Yazarlar(YazarAdi,YazarTC,YazarAdres)
VALUES('Namýk Kemal','12090651913','Ýstanbul')
...
--HANGÝ YAYINEVÝ ADRES HANGÝ KÝTAP
SELECT YayýneviAdres, KitapAdi
FROM Yayinevi, Kitaplar
WHERE Yayinevi.YayýneviAdi=Kitaplar.YayineviAdi
...
INSERT INTO Kitaplar(KitapAdi,Isbn,YazarTC,YayineviAdi)
VALUES('Heidi',1900,12345678901,'Ýþ Bankasý')
